      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="p-8 md:p-12 bg-card border-sepia-light shadow-medium">
          <div className="prose prose-lg max-w-none font-crimson text-foreground leading-relaxed">
            <p className="text-xl text-sepia-white first-letter:text-6xl first-letter:font-playfair first-letter:font-bold first-letter:text-primary first-letter:float-left first-letter:mr-3 first-letter:mt-1">
            ...
            <p className="mt-4 text-lg md:text-xl text-primary font-playfair font-bold text-center">
