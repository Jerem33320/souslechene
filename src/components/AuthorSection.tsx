      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="p-8 md:p-12 bg-card border-sepia-light shadow-medium">
          <div className="prose prose-lg max-w-none font-crimson text-foreground leading-relaxed">
            <p className="mt-4 text-lg md:text-xl text-sepia-white first-letter:text-5xl first-letter:font-playfair first-letter:font-bold first-letter:text-primary first-letter:float-left first-letter:mr-3 first-letter:mt-1">
            ...
            <p className="mt-4 text-lg md:text-xl text-sepia-white">
          ...
          <div className="mt-8 pt-8 border-t border-sepia-light">
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <p className="font-crimson text-sepia-white">Ingénieur</p>
              </div>
              <div>
                <h4 className="font-playfair font-semibold text-primary mb-2">Passions</h4>
                <p className="font-crimson text-sepia-white">Histoire, Géographie, Géopolitique</p>
              </div>
              <div>
                <h4 className="font-playfair font-semibold text-primary mb-2">Inspiration</h4>
                <p className="font-crimson text-sepia-white">Les autres, Voyages & Découvertes</p>
              </div>
            </div>
          </div>
        </Card>
